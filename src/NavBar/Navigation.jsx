...
function Navigation() {
  return (
    <div>
      <div className="flex items-center gap-15 text-[20px] p-2.5 h-20 bg-amber-300 ">
        ...
        <div className=" flex justify-end items-end space-x-4">
          ...
          <NavLink
            to="/login"
            className="text-blue-500 border-[1px] border-amber-50 h-[35px] hover:bg-blue-500 hover:text-white w-[80px] flex justify-center rounded-[10px]"
          >
            Login
          </NavLink>
          <NavLink
            to="/register"
            className=" bg-blue-600 text-white w-[85px] flex justify-center h-[35px] rounded-[10px] hover:bg-blue-900"
          >
            Register
          </NavLink>
          <NavLink className="hover:text-blue-700">
