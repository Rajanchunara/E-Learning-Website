          ...
          <div className="flex">
            <div className="w-[900px] ">
              {cartItem.map((item) => {
                return (
                  <div key={item.id}>
                    <div className="flex justify-evenly items-center m-4 h-56 rounded-2xl shadow-2xl shadow-black ">
                      <div>
                        <img
                          className="h-38 rounded-2xl"
                          src={item.image}
                          alt=""
                        />
                      </div>
                      <div className=" h-14 ">
                        <h1 className="text-[25px]">{item.course}</h1>
                      </div>

                      <div className=" h-14 space-y-2">
                        <h1 className=" text-red-500 text-[25px]">
                          {" "}
                          Rs. {item.cost}
                        </h1>
